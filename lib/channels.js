...
function Channels(client, options) {
  ...
  this.client.ready ? ready() : this.client.on('ready', ready)
  ...
  this.client.on('pmessage', this.pmessage.bind(this))
}
...
Channels.prototype.pmessage = function(pattern, channel, data) {
  return this.message(channel, data)
}
...
Channels.prototype.message = function(channel, data) {
